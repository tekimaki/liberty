...
<iframe src="about:blank" id="liberty_upload_frame_{$frame_id}" name="liberty_upload_frame_{$frame_id}" onload="javascript:LibertyPreflight.uploaderComplete('liberty_upload_frame_{$frame_id}', 'edit_preflight_list_{$frame_id}', 'upload_{$frame_id}', '{$frame_id});" style="position: absolute; left: -10000px;">
	<div class="warning">
