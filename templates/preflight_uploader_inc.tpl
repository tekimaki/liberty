...
<iframe src="about:blank" id="liberty_upload_frame_{$frame_id}" name="liberty_upload_frame_{$frame_id}" onload="javascript:LibertyPreflight.uploaderComplete('liberty_upload_frame_{$frame_id}', '{$frame_id}', '{$formid|default:editpageform}');" style="position: absolute; left: -10000px;">
	<div class="warning">
