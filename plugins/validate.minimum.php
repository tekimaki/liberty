...
function validate_min($pVar, $pConstraints, &$pParamHash, &$pErrors, &$pStore, $pObject = NULL) {
  if (!empty($pConstraints['min']) && ( empty($pParamHash[$pVar]) || strlen($pParamHash[$pVar]) < $pConstraints['min'] )) {
